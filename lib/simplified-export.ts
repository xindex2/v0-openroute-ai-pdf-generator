...
export async function generatePdf(contentElement: HTMLElement): Promise<Blob> {
  try {
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      pdf.text(`Generated by WriteDoc.ai - Page ${i} of ${pageCount}`, 105, 290, { align: "center" })
    }
  ...
  try {
    ...
    try {
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        pdf.setFontSize(10)
        pdf.setTextColor(150, 150, 150)
        pdf.text(`Generated by WriteDoc.ai - Page ${i} of ${pageCount}`, imgWidth / 2, pageHeight - 10, {
          align: "center",
        })
      }
...
function generateFallbackPdf(contentElement: HTMLElement): Promise<Blob> {
  return new Promise((resolve) => {
    ...
    pdf.setFontSize(10)
    pdf.setTextColor(150, 150, 150)
    pdf.text("Generated by WriteDoc.ai", 105, 280, { align: "center" })
...
function generateFallbackImage(contentElement: HTMLElement): Promise<Blob> {
  return new Promise((resolve) => {
    ...
    ctx.fillText("Generated by WriteDoc.ai", canvas.width / 2 - 60, canvas.height - 20)
...
export function generateHtml(contentElement: HTMLElement): Blob {
  try {
    ...
    const html = `
      ...
      <body>
        ${contentElement.innerHTML}
        <footer>Generated by WriteDoc.ai</footer>
      </body>
      </html>
    `
